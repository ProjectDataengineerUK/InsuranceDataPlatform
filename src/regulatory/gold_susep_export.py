...
from pyspark.sql.functions import col, current_timestamp, date_format, first
...
def build_gold_susep_claims(silver_df: DataFrame) -> DataFrame:
    ...
    return (
        ...
        .select("COD_APO", "D_OCORR", "INDENIZ", "REGIAO", "CAUSA")
    )
...
def run_gold_export_job(
    ...
    gold_claims_df = build_gold_susep_claims(silver_df)
